...
public class AircraftManager : MonoBehaviour
{
    ...
    void FixedUpdate()
    {
        ...
        SetControlFlap(portAileron, portWingOuter, portAileronTrim, aileronDelta);
        SetControlFlap(starboardAileron, starboardWingOuter,starboardAileronTrim, -aileronDelta);
        SetControlFlap(portElevator,  portTailPlane,portElevatorTrim, elevatorDelta+rudderDelta);
        SetControlFlap(starboardElevator,  starboardTailPlane, starboardElevatorTrim, elevatorDelta-rudderDelta);
        ...
        SetControlFlap(portFlap, portWingInner,portFlapTrim, flapAngle);
        SetControlFlap(starboardFlap, starboardWingInner, starboardFlapTrim, flapAngle) ;
        
    }

    void SetControlFlap(Transform hinge, AeroBody aeroBody,Quaternion trim, float delta)
    {
